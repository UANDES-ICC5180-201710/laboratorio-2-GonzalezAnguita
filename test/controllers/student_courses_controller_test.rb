...
class StudentCoursesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create student_course" do
    assert_difference('StudentCourse.count') do
      post student_courses_url, params: { student_course: { course_id: @student_course.course_id, person_id: @student_course.person_id } }
    end
  ...
  test "should update student_course" do
    patch student_course_url(@student_course), params: { student_course: { course_id: @student_course.course_id, person_id: @student_course.person_id } }
